...
public class ReminderNotification {
    ...
    public static void notify(final Context context,
                              final String title1, final int number, final String textString, boolean friend, String description) {
        ...
        if(friend)
            picture = BitmapFactory.decodeResource(res, R.drawable.profile);

        else
            picture = BitmapFactory.decodeResource(res, R.drawable.time);
